...
export default function Identificar() {
  ...
  const mockResult = {
    ...
    ecologicalRole: "Predador de topo de cadeia, essencial para o equilíbrio do ecossistema ao controlar populações de presas.",
    careInstructions: "Mantenha distância. Nunca dê as costas ou corra. Notifique as autoridades ambientais locais.",
    funFact: "A onça-pintada possui a mordida mais forte entre todos os felinos do mundo, capaz de perfurar até cascos de tartarugas."
  };
  ...
  return (
    <ScreenWrapper>
      ...
      > 
        {status !== 'result' ? (
          <View>
            ...
            <ActionButtons 
              onCameraPress={handleStartAnalysis}
              onGalleryPress={handleStartAnalysis}
            />
          </View>
        ) : (
          ...
          <View>
             <View style={styles.resultHeader}>
              ...
              <TouchableOpacity style={styles.resetButton} onPress={handleReset}>
                 <MaterialCommunityIcons name="refresh" size={20} color={palette.verdePrimary} />
      ...
      {/* O Loading fora do ScrollView e no final do código
          para sobrepor tudo*/}
      {status === 'loading' && (
        <AnalysisLoading onCancel={handleReset} />
      )}
